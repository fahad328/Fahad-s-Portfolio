...
const Hero = () => {
  return(
    <div id="hero" className="hero">
        ...
        <p>I am a dedicated and skilled Frontend Developer with 2 years of professional experience in creating dynamic <br />and responsive web applications. Proficient in HTML, CSS, JavaScript, and modern frontend frameworks like React. </p>
